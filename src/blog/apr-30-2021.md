...
I started my career just by reading coding books at Barnes N Noble and freelancing on various web projects almost 10 years ago. You can read more about my story [here](https://javascriptla.net/blog/what-it-feels-like-to-be-a-developer-in-2020-my-story/). One thing led to another, and I started working full time around 2013. There were a few hiccups along the way, but I got into the groove of coding for real (basically feeling less imposter syndrome) by 2015.
...
<blockquote class="note">Eventually my job was to just "support" by writing small snippets of code or by making repetitive text and image changes to 30 different sites now on the multi-site.</blockquote>
