    ...
    return (
        <Layout>
            ...
            <section>
                ...
                <p>By all means, reach out.  You can probably get ahold of me faster via LinkedIn, though I would encourage you to check out JavaScriptLA to network with myself and the group, or visit HackBuddy.com (my other website for training in fullstack web development).</p>
