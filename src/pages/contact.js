      ...
      <Container style={{ marginTop: `2rem` }}>
        <section>
          <h3 style={{ textAlign: `center` }}>
            If Contacting Me About Jobs / Sales Inquiries
          </h3>
          <p>
            Please note, I only respond to serious inquiries. In addition, I
            occassionally have hired assistants help me read and respond to
            ...
            directly and make requests there.
          </p>
          <p>
            Also please note, I am not looking for contract work at this time. I
            will consider only roles that are full time, with health benefits,
            offer good pay and allow remote work from home. As mentioned on the{" "}
            <Link to="/">home page</Link>, I tend to look for work that helps me
            advance my skills, as it is my skills that help me get by market
            wise.
          </p>
          <p>
            Finally, if I do not respond, please do not take it personally, it
            ...
            lengthy emails back and forth. Thanks and have a great day!
          </p>
        </section>
        <section>
          <h3 style={{ marginTop: `2rem`, textAlign: `center` }}>
            If Contacting Me For Mentorship / Advice
          </h3>
          <p>
