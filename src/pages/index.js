...
const IndexPage = () => (
  <Layout>
    ...
    <section style={{textAlign: `center`}}>
      ...
      <p style={{textAlign: `left`}}>The answer is degrees of complexity.  While I was thinking I was so great for having a college degree, that low level grocery bagger was studying hard at night to acquire new, useful skills that could make he or she money; and right now.  While I was spending nights feeling sorry for myself that no one cared about how smart I was and how I couldn't get a raise even after years of working "hard"; this other person networked hard and made great new connections and took opportunities that I never did.</p>  
